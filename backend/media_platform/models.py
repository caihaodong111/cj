...
class BilibiliVideo(BaseModel):
    ...
    ip_location = models.TextField(default='', blank=True, verbose_name="IP Location")
...
class DouyinAweme(BaseModel):
    ...
    aweme_id = models.BigIntegerField(unique=True, db_index=True, verbose_name="Aweme ID")
...
class KuaishouVideo(BaseModel):
    ...
    avatar = models.TextField(null=True, blank=True)
    ip_location = models.TextField(default='', blank=True, verbose_name="IP Location")
    video_id = models.CharField(max_length=255, unique=True, db_index=True, verbose_name="Video ID")
    video_type = models.TextField(null=True, blank=True)
    title = models.TextField(null=True, blank=True)
    desc = models.TextField(null=True, blank=True)
    create_time = models.BigIntegerField(db_index=True, null=True, blank=True)
...
class WeiboNote(BaseModel):
    ...
    note_id = models.BigIntegerField(unique=True, db_index=True, verbose_name="Note ID")
    content = models.TextField(null=True, blank=True)
    create_time = models.BigIntegerField(db_index=True, null=True, blank=True)
...
class XhsNote(BaseModel):
    ...
    avatar = models.TextField(null=True, blank=True)
    ip_location = models.TextField(null=True, blank=True)
    note_id = models.CharField(max_length=255, unique=True, db_index=True, verbose_name="Note ID")
    type = models.TextField(null=True, blank=True)
    title = models.TextField(null=True, blank=True)
    desc = models.TextField(null=True, blank=True)
    video_url = models.TextField(null=True, blank=True)
...
class TiebaNote(BaseModel):
    """Tieba note model"""
    note_id = models.CharField(max_length=644, unique=True, db_index=True, verbose_name="Note ID")
    title = models.TextField(null=True, blank=True)
    desc = models.TextField(null=True, blank=True)
    note_url = models.TextField(null=True, blank=True)
    publish_time = models.BigIntegerField(db_index=True, null=True, blank=True)
...
class ZhihuContent(BaseModel):
    """Zhihu content model"""
    content_id = models.CharField(max_length=64, unique=True, db_index=True, verbose_name="Content ID")
    ...
    desc = models.TextField(null=True, blank=True)
    ip_location = models.TextField(default='', blank=True, verbose_name="IP Location")
    created_time = models.BigIntegerField(db_index=True, null=True, blank=True)
    updated_time = models.BigIntegerField(null=True, blank=True)
