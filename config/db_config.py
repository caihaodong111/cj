...
# mysql config
MYSQL_DB_PWD = os.getenv("MYSQL_DB_PWD", "lxr123123")
MYSQL_DB_USER = os.getenv("MYSQL_DB_USER", "lxr")
MYSQL_DB_HOST = os.getenv("MYSQL_DB_HOST", "39.105.122.26")
MYSQL_DB_PORT = os.getenv("MYSQL_DB_PORT", 3306)
MYSQL_DB_NAME = os.getenv("MYSQL_DB_NAME", "lxr")
